...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getKnpSnappy_ImageService()
    {
        ...
        $instance->setTemporaryFolder(__DIR__);
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $c = ${($_ = isset($this->services['security.user.provider.concrete.user_provider']) ? $this->services['security.user.provider.concrete.user_provider'] : $this->getSecurity_User_Provider_Concrete_UserProviderService()) && false ?: '_'};
        ...
        $j = new \Symfony\Component\HttpFoundation\RequestMatcher('^/recuperarPassword');

        $k = new \Symfony\Component\HttpFoundation\RequestMatcher('^/resetPassword');
        ...
        $o = new \Symfony\Component\HttpFoundation\RequestMatcher('^/partes$');

        $p = new \Symfony\Component\HttpFoundation\RequestMatcher('^/parte/');

        $q = new \Symfony\Component\HttpFoundation\RequestMatcher('^/sanciones$');

        $r = new \Symfony\Component\HttpFoundation\RequestMatcher('^/sancion/');
    ...
    {
        return $this->services['cache.serializer.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('D3S00zcgWL', 0, 'dSjOGnVyqV+BNYnWiplLri', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['cache.system.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('yN5nGJ8+Cj', 0, 'dSjOGnVyqV+BNYnWiplLri', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['cache.validator.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('yk16wBa4JW', 0, 'dSjOGnVyqV+BNYnWiplLri', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['security.authentication.provider.anonymous.main'] = new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5a1dc58f5a6198.61160320');
    }
        ...
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = array(
                ...
                'KnpSnappyBundle' => array(
                    'parent' => NULL,
                    'path' => 'D:/Lucas/GitHub/shikoba/vendor/knplabs/knp-snappy-bundle',
