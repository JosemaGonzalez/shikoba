...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            '1_fdec6ad8a512ab8736395dab88dc27c5ef7c9f1df20cfd54b1e1e8023f68f09e' => 'get1Fdec6ad8a512ab8736395dab88dc27c5ef7c9f1df20cfd54b1e1e8023f68f09eService',
            '2_fdec6ad8a512ab8736395dab88dc27c5ef7c9f1df20cfd54b1e1e8023f68f09e' => 'get2Fdec6ad8a512ab8736395dab88dc27c5ef7c9f1df20cfd54b1e1e8023f68f09eService',
        ...
        $this->privates = array(
            '1_fdec6ad8a512ab8736395dab88dc27c5ef7c9f1df20cfd54b1e1e8023f68f09e' => true,
            '2_fdec6ad8a512ab8736395dab88dc27c5ef7c9f1df20cfd54b1e1e8023f68f09e' => true,
    ...
    /**
     * Gets the public 'app.alumnoHelper' shared service.
     *
     * @return \AppBundle\Services\AlumnoHelper
     */
    protected function getApp_AlumnoHelperService()
    {
        return $this->services['app.alumnoHelper'] = new \AppBundle\Services\AlumnoHelper(${($_ = isset($this->services['doctrine.orm.default_entity_manager']) ? $this->services['doctrine.orm.default_entity_manager'] : $this->get('doctrine.orm.default_entity_manager')) && false ?: '_'});
    }

    /**
     * Gets the public 'app.crearSancionHelper' shared service.
     *
     * @return \AppBundle\Services\CrearSancionHelper
     */
    protected function getApp_CrearSancionHelperService()
    {
        return $this->services['app.crearSancionHelper'] = new \AppBundle\Services\CrearSancionHelper(${($_ = isset($this->services['doctrine.orm.default_entity_manager']) ? $this->services['doctrine.orm.default_entity_manager'] : $this->get('doctrine.orm.default_entity_manager')) && false ?: '_'});
    }

    /**
     * Gets the public 'app.diarioHelper' shared service.
     *
     * @return \AppBundle\Services\DiarioHelper
     */
    protected function getApp_DiarioHelperService()
    {
        return $this->services['app.diarioHelper'] = new \AppBundle\Services\DiarioHelper(${($_ = isset($this->services['doctrine.orm.default_entity_manager']) ? $this->services['doctrine.orm.default_entity_manager'] : $this->get('doctrine.orm.default_entity_manager')) && false ?: '_'});
    }

    /**
     * Gets the public 'app.importHelper' shared service.
     *
     * @return \AppBundle\Services\ImportHelper
     */
    ...
    protected function getConfigCacheFactoryService()
    {
        return $this->services['config_cache_factory'] = new \Symfony\Component\Config\ResourceCheckerConfigCacheFactory(new RewindableGenerator(function () {
            yield 0 => ${($_ = isset($this->services['1_fdec6ad8a512ab8736395dab88dc27c5ef7c9f1df20cfd54b1e1e8023f68f09e']) ? $this->services['1_fdec6ad8a512ab8736395dab88dc27c5ef7c9f1df20cfd54b1e1e8023f68f09e'] : $this->get1Fdec6ad8a512ab8736395dab88dc27c5ef7c9f1df20cfd54b1e1e8023f68f09eService()) && false ?: '_'};
            yield 1 => ${($_ = isset($this->services['2_fdec6ad8a512ab8736395dab88dc27c5ef7c9f1df20cfd54b1e1e8023f68f09e']) ? $this->services['2_fdec6ad8a512ab8736395dab88dc27c5ef7c9f1df20cfd54b1e1e8023f68f09e'] : $this->get2Fdec6ad8a512ab8736395dab88dc27c5ef7c9f1df20cfd54b1e1e8023f68f09eService()) && false ?: '_'};
        }, 2));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = ${($_ = isset($this->services['doctrine.dbal.connection_factory']) ? $this->services['doctrine.dbal.connection_factory'] : $this->get('doctrine.dbal.connection_factory')) && false ?: '_'}->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'shikoba', 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array('enum' => 'string'));
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_7594a57da215962834faf437fd52712dd1324ddc7132494fee2164928de5e0bc');
    ...
    /**
     * Gets the public 'form.parteType' shared service.
     *
     * @return \AppBundle\Form\ParteFormType
     */
    protected function getForm_ParteTypeService()
    {
        return $this->services['form.parteType'] = new \AppBundle\Form\ParteFormType(${($_ = isset($this->services['doctrine.orm.default_entity_manager']) ? $this->services['doctrine.orm.default_entity_manager'] : $this->get('doctrine.orm.default_entity_manager')) && false ?: '_'});
    }
...
>>>>>>> e9cd42fbf60c336d3d1df49e677497151b9feb8b
    ...
    /**
     * Gets the private '1_fdec6ad8a512ab8736395dab88dc27c5ef7c9f1df20cfd54b1e1e8023f68f09e' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\Config\ContainerParametersResourceChecker
     */
    protected function get1Fdec6ad8a512ab8736395dab88dc27c5ef7c9f1df20cfd54b1e1e8023f68f09eService()
    {
        return $this->services['1_fdec6ad8a512ab8736395dab88dc27c5ef7c9f1df20cfd54b1e1e8023f68f09e'] = new \Symfony\Component\DependencyInjection\Config\ContainerParametersResourceChecker($this);
    }

    /**
     * Gets the private '2_fdec6ad8a512ab8736395dab88dc27c5ef7c9f1df20cfd54b1e1e8023f68f09e' shared service.
     *
     * @return \Symfony\Component\Config\Resource\SelfCheckingResourceChecker
     */
    protected function get2Fdec6ad8a512ab8736395dab88dc27c5ef7c9f1df20cfd54b1e1e8023f68f09eService()
    {
        return $this->services['2_fdec6ad8a512ab8736395dab88dc27c5ef7c9f1df20cfd54b1e1e8023f68f09e'] = new \Symfony\Component\Config\Resource\SelfCheckingResourceChecker();
    }
    ...
    {
<<<<<<< HEAD
        return $this->services['cache.annotations.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('NusdFLPCRh', 0, '8BDZ8F9atLrc2VeRj1d6GX', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
=======
        return $this->services['cache.annotations.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('uSW9zbiRXa', 0, 'CQJD3SfuEBqO1rh9McCeGu', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
>>>>>>> e9cd42fbf60c336d3d1df49e677497151b9feb8b
    }
    ...
    {
        $this->services['cache.app.recorder_inner'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('dGM2gaJVyB', 0, (__DIR__.'/pools'));
    ...
    {
<<<<<<< HEAD
        return $this->services['cache.serializer.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('D3S00zcgWL', 0, '8BDZ8F9atLrc2VeRj1d6GX', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
=======
        return $this->services['cache.serializer.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('cMU0lPatoz', 0, 'CQJD3SfuEBqO1rh9McCeGu', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
>>>>>>> e9cd42fbf60c336d3d1df49e677497151b9feb8b
    }
    ...
    {
<<<<<<< HEAD
        return $this->services['cache.system.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('yN5nGJ8+Cj', 0, '8BDZ8F9atLrc2VeRj1d6GX', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
=======
        return $this->services['cache.system.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('pU3WIUY3cY', 0, 'CQJD3SfuEBqO1rh9McCeGu', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
>>>>>>> e9cd42fbf60c336d3d1df49e677497151b9feb8b
    }
    ...
    {
<<<<<<< HEAD
        return $this->services['cache.validator.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('yk16wBa4JW', 0, '8BDZ8F9atLrc2VeRj1d6GX', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
=======
        return $this->services['cache.validator.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('qHX72VvaTz', 0, 'CQJD3SfuEBqO1rh9McCeGu', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
>>>>>>> e9cd42fbf60c336d3d1df49e677497151b9feb8b
    }
    ...
    {
<<<<<<< HEAD
        return $this->services['security.authentication.provider.anonymous.main'] = new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('59cf8c7543c600.69944080');
=======
        return $this->services['security.authentication.provider.anonymous.main'] = new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('59d67b0eeaeba1.86702300');
>>>>>>> e9cd42fbf60c336d3d1df49e677497151b9feb8b
    }
    ...
    {
        return $this->services['security.user.provider.concrete.user_provider'] = new \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider(${($_ = isset($this->services['doctrine']) ? $this->services['doctrine'] : $this->get('doctrine')) && false ?: '_'}, 'AppBundle:Usuarios', 'usuario', NULL);
    }
