...
class __TwigTemplate_db910f0e0eee21f763be970759c0bf5981905b7640033acd515914947d8a9491 extends Twig_Template
{
    public function __construct(Twig_Environment $env)
    {
        ...
        // line 1
        $this->parent = $this->loadTemplate("base.html.twig", "convivencia/admin/gestionProfesores.html.twig", 1);
        $this->blocks = array(
    ...
    <div class=\"w3-row w3-container w3-margin-bottom\" id=\"contenedorUpload\">
        <h1 class=\"w3-center\">Importar Profesores</h1>
        <h2 class=\"w3-center\"><i class=\"fa fa-info-circle fa-lg tooltip\" data-tooltip-content=\"#tooltip_content\"></i></h2>

        <div class=\"tooltip_templates\">
        <span id=\"tooltip_content\">
            <p>Debe ser un fichero csv con el siguiente orden de campos:</p><p>Nombre, Primer Apellido, Segundo Apellido, Teléfono, Correo Electrónico</p>
        </span>
        </div>
        ...
        $context['_seq'] = twig_ensure_traversable($this->getAttribute($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : null), "session", array()), "flashBag", array()), "get", array(0 => "profesor"), "method"));
        ...
        // line 27
        $context['_parent'] = $context;
        $context['_seq'] = twig_ensure_traversable($this->getAttribute($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : null), "session", array()), "flashBag", array()), "get", array(0 => "profesorError"), "method"));
        foreach ($context['_seq'] as $context["_key"] => $context["flash_message"]) {
            // line 28
        ...
        echo "
        <input class=\"w3-button w3-block w3-section .azulTemaButton w3-text-white\" id=\"botonImportar\" type=\"submit\" name=\"importarProfesores\" value=\"Importar\" disabled>
        ";
        // line 36
