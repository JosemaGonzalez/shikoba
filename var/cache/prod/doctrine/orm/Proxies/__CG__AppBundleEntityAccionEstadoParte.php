 ...
 */
class AccionEstadoParte extends \AppBundle\Entity\AccionEstadoParte implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\AccionEstadoParte' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\AccionEstadoParte' . "\0" . 'estado', '' . "\0" . 'AppBundle\\Entity\\AccionEstadoParte' . "\0" . 'accion'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (AccionEstadoParte $proxy) {
