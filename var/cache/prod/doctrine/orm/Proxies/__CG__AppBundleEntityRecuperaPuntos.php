 ...
 */
class RecuperaPuntos extends \AppBundle\Entity\RecuperaPuntos implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\RecuperaPuntos' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\RecuperaPuntos' . "\0" . 'fecha', '' . "\0" . 'AppBundle\\Entity\\RecuperaPuntos' . "\0" . 'descripcion', '' . "\0" . 'AppBundle\\Entity\\RecuperaPuntos' . "\0" . 'observaciones', '' . "\0" . 'AppBundle\\Entity\\RecuperaPuntos' . "\0" . 'puntos', '' . "\0" . 'AppBundle\\Entity\\RecuperaPuntos' . "\0" . 'idParte', '' . "\0" . 'AppBundle\\Entity\\RecuperaPuntos' . "\0" . 'idAlumno'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (RecuperaPuntos $proxy) {
