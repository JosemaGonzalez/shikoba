 ...
 */
class AccionEstadoSancion extends \AppBundle\Entity\AccionEstadoSancion implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\AccionEstadoSancion' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\AccionEstadoSancion' . "\0" . 'estado', '' . "\0" . 'AppBundle\\Entity\\AccionEstadoSancion' . "\0" . 'accion'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (AccionEstadoSancion $proxy) {
